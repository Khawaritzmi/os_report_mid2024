...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=1\textwidth]{D:/Universitas Hasanuddin/Semester III/Sistem Operasi/Repository/os_report_mid2024/a_class/asset/pid-illustration.png}
        ...
        Menurut Arpaci-Dusseau dan Arpaci-Dusseau (2018), alokasi 
...
\begin{itemize}
    ...
    \item Algoritma Round Robin dengan kuantum waktu 2 unit menunjukkan waktu penyelesaian yang efisien, tetapi waktu tunggu rata-rata yang lebih tinggi dibandingkan SJN.
\end{itemize}
