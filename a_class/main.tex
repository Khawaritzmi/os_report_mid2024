...
\begin{enumerate}
    ...
    \item \textit{Bus} \textit{Peripheral Component Interconnect} (PCI ) suatu rancangan komputer yang dapat digunakan dalam banyak konfigurasi dan memiliki sebuah penghubung kepada bus ISA. 
\end{enumerate}
