...
\subsection{Basic Concepts and Components of Computer Systems}
    ...
    Sistem adalah kumpulan komponen yang saling berinteraksi dan bekerja sama untuk mencapai tujuan tertentu.
    ...
    Berdasarkan kedua definisi tersebut, Sistem komputer adalah kumpulan perangkat komputer yang saling terkait dan berinteraksi untuk menjalankan suatu aktivitas atau program menggunakan komputer. Sistem komputer terdiri dari tiga komponen utama: Hardware (perangkat keras), Software (perangkat lunak), dan Brainware (manusia/pengguna)
    
Konsep Dasar Sistem Komputer

1. Hardware (Perangkat Keras)
Hardware adalah bagian fisik dari sistem komputer yang dapat disentuh. Komponen utama hardware meliputi:
\begin{itemize}
    \item Motherboard: Papan induk yang menghubungkan semua komponen hardware.
...
Software adalah instruksi yang menjalankan hardware. Komponen utama software meliputi:
