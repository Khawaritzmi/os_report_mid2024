...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Xen: Meskipun menggunakan paravirtualisasi, \textit{Xen} juga memanfaatkan ekstensi \textit{hardware} untuk meningkatkan performa.
        \end{itemize}
    \end{itemize}
    ...
    \newline Virtualisasi Berbasis Hardware (\textit{Hardware-Assisted Virtualization}) mirip dengan Virtualisasi Penuh dan Paravirtualisasi, tetapi memiliki perbedaan mendasar karena bergantung pada ekstensi \textit{hardware} khusus yang dirancang untuk mengurangi \textit{overhead} dan meningkatkan performa. Teknik ini memanfaatkan fitur yang ada dalam prosesor modern, seperti \textit{Intel VT} (Vanderpool) dan \textit{AMD-V}(Pacifica), untuk menangani tugas yang biasanya menyebabkan kemacetan dalam virtualisasi berbasis perangkat lunak, terutama operasi I/O dan instruksi terkawal pada sistem operasi tamu.
